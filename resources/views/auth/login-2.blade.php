...
<head>
    ...
    <meta name="description" content="Lumia consulting, connectez-vous et profitez de nos services" />
    <meta name="format-detection" content="telephone=no">
    <!-- PAGE TITLE HERE -->
    <title>Lumia - Connexion</title>
...
<div class="authincation d-flex flex-column flex-lg-row flex-column-fluid">
    <div class="login-aside text-center  d-flex flex-column flex-row-auto">
        <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
            ...
            <h3 class="mb-2 text-white">Ravi de vous revoir!</h3>
            <p class="mb-4">Profitez des services de  <br>Lumia Consulting</p>
        </div>
        <div class="aside-image position-relative" style="background-image:url(../static/akademi/images/background/pic-2.png);">
            <img class="img1 move-1" src="../static/akademi/images/background/pic3.png" alt="">
            <img class="img2 move-2" src="../static/akademi/images/background/pic4.png" alt="">
            <img class="img3 move-3" src="../static/akademi/images/background/pic5.png" alt="">
                        ...
                        <div id="sign-up" class="auth-form tab-pane fade show active  form-validation">
                            <form action="../index/index.html">
                                <div class="text-center mb-4">
                                    <h3 class="text-center mb-2 text-black">Connectez-vous</h3>
                            ...
                            <div class="new-account mt-3 text-center">
                                <p class="font-w500">Already have an account? <a class="text-primary" href="index.html#sign-in" data-toggle="tab">Sign in</a></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="../static/akademi/vendor/global/global.min.js"></script>
...
<script src="../static/akademi/js/dlabnav-init.js"></script>
