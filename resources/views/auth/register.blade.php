...
<head>
    ...
    <meta name="description" content="Lumia consulting, inscrivez-vous et profitez de nos services" />
                    ...
                    <div class="col-xl-12 tab-content">
                        <div id="sign-up" class="auth-form tab-pane fade show active  form-validation">
                            ...
                            <div class="new-account mt-3 text-center">
                                <p class="font-w500">Already have an account? <a class="text-primary" href="../page-login/index.html">Sign in</a></p>
                            </div>
                        </div>
                    </div>
                </div>
