        ...
        <div class="col-xl-12">
            <div class="card bg-transparent mb-1">
                <div class="card-header border-0 px-3">
                    ...
                    <div>
                        <a href="index.html#" class="add icon-box bg-primary" data-bs-toggle="modal"
                ...
                <div class="card-body height450 dlab-scroll loadmore-content recent-activity-wrapper p-3 pt-2"
                    ...
                    <div class="d-flex align-items-center student">
								<span class="dz-media">
									<img src="../static/akademi/images/profile/small/pic1.jpg" alt="" width="50"
                                         class="avatar">
								</span>
                        <div class="user-info">
                            <h6 class="name"><a href="../app-profile/index.html">Samantha William</a></h6>
                    ...
                    <div class="d-flex align-items-center student">
								<span class="dz-media">
									<img src="../static/akademi/images/profile/small/pic2.jpg" alt="" width="50"
                                         class="avatar">
								</span>
                        <div class="user-info">
                            <h6 class="name"><a href="../app-profile/index.html">Tony Soap</a></h6>
                    ...
                    <div class="d-flex align-items-center student">
								<span class="dz-media">
									<img src="../static/akademi/images/profile/small/pic3.jpg" alt="" class="avatar">
								</span>
                        <div class="user-info">
                            <h6 class="name"><a href="../app-profile/index.html">Karen Hope</a></h6>
                    ...
                    <div class="d-flex align-items-center student">
								<span class="dz-media">
									<img src="../static/akademi/images/profile/small/pic4.jpg" alt="" class="avatar">
								</span>
                        <div class="user-info">
                            <h6 class="name"><a href="../app-profile/index.html">Jordan Nico</a></h6>
                    ...
                    <div class="d-flex align-items-center student">
								<span class="dz-media">
									<img src="../static/akademi/images/profile/small/pic5.jpg" alt="" class="avatar">
								</span>
                        <div class="user-info">
                            <h6 class="name"><a href="../app-profile/index.html">Nadila Adja</a></h6>
                ...
                <div class="card-footer text-center border-0 pt-0 px-3 pb-0">
                    <a href="javascript:void(0);"
                       class="btn btn-block btn-primary light btn-rounded dlab-load-more" id="RecentActivity"
                       rel="/static/akademi/ajax/recentactivity.html">View More</a>
                </div>
            </div>
        </div>
        <!--/column-->
        ...
        <div class="col-xl-12">
            <div class="card massage bg-transparent mb-0">
                ...
                <div class="card-body height450 dlab-scroll p-0 px-3" id="messageContent">
                    ...
                    <div class="d-flex student border-bottom">
                        <div class="d-flex align-items-center">
									<span class="dz-media">
										<img src="../static/akademi/images/profile/small/pic1.jpg" alt=""
                                             class="avatar">
									</span>
                            <div class="user-info">
                                <h6 class="name"><a href="../app-profile/index.html">Samantha William</a></h6>
                    ...
                    <div class="d-flex student border-bottom">
                        <div class="d-flex align-items-center">
									<span class="dz-media">
										<img src="../static/akademi/images/profile/small/pic2.jpg" alt=""
                                             class="avatar">
									</span>
                            <div class="user-info">
                                <h6 class="name"><a href="../app-profile/index.html">Tony Soap</a></h6>
                    ...
                    <div class="d-flex student border-bottom">
                        <div class="d-flex align-items-center">
									<span class="dz-media">
										<img src="../static/akademi/images/profile/small/pic3.jpg" alt=""
                                             class="avatar">
									</span>
                            <div class="user-info">
                                <h6 class="name"><a href="../app-profile/index.html">Jordan Nico</a></h6>
                    ...
                    <div class="d-flex student border-bottom">
                        <div class="d-flex align-items-center">
									<span class="dz-media">
										<img src="../static/akademi/images/profile/small/pic4.jpg" alt=""
                                             class="avatar">
									</span>
                            <div class="user-info">
                                <h6 class="name"><a href="../app-profile/index.html">Nadila Adja</a></h6>
                ...
                <div class="card-footer text-center border-0 px-3 pb-0">
                    <a href="javascript:void(0);"
                       class="btn btn-block btn-primary light btn-rounded dlab-load-more" id="message"
                       rel="/static/akademi/ajax/message-content.html">View More</a>
                </div>
            </div>
        </div>
        <!--/column-->
            ...
            <div class="card tags bg-transparent mb-0">
                ...
                <div class="card-body  p-3 py-1 ">
                    <div class="card-body-inner food">
								<span class="dz-media">
									<img src="../static/akademi/images/food/pic1.jpg" alt="" class="avatar">
								</span>
                        <div class="user-info">
                            <h5 class="name"><a href="../app-profile/index.html">Beef Steak with Fried
                                    Potato</a></h5>
                            <span class="fs-14 font-w400 text-wrap">Lorem ipsum dolor sit</span>
                        </div>
                    </div>
                    <div class="card-body-inner food">
								<span class="dz-media">
									<img src="../static/akademi/images/food/pic2.jpg" alt="" class="avatar">
								</span>
                        <div class="user-info">
                            <h5 class="name"><a href="../app-profile/index.html">Pancake with Honey</a></h5>
                            <span class="fs-14 font-w400 text-wrap">Lorem ipsum dolor sit</span>
                        </div>
                    </div>
                    <div class="card-body-inner food">
								<span class="dz-media">
									<img src="../static/akademi/images/food/pic3.jpg" alt="" class="avatar">
								</span>
                        <div class="user-info">
                            <h5 class="name"><a href="../app-profile/index.html">Japanese Beef Ramen</a></h5>
                            <span class="fs-14 font-w400 text-wrap">Lorem ipsum dolor sit</span>
                        </div>
                    </div>
                </div>
