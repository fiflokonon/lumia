...
@section('page_title', 'Liste des roles')
<!--**********************************
    Content body start
***********************************-->
@section('content')
                    ...
                    <div class="table-responsive full-data">
                        <table class="table-responsive-lg table display dataTablesCard student-tab dataTable no-footer" id="example-student">
                            ...
                            <tr>
                                <th>Intitulé</th>
                                <th>Statut</th>
                                <th>Date <span class="text-lowercase">de création</span></th>
                                ...
                                <td>
                                    <div class="dropdown custom-dropdown float-end">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            @endif
                                            <a class="dropdown-item" href="{{ route('role_details', $role->id) }}" target="_blank"><i class="fa fa-edit"></i> Modifier le role</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
