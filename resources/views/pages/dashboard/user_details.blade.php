...
@section('page_title', "Informations de l'utilisateur")
<!--**********************************
    Content body start
***********************************-->
@section('content')
                            ...
                            <div class="card h-auto schedule-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div>
                                            <img src="../static/akademi/images/avatar/1.jpg" class="avatar avatar-lg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card h-auto schedule-card-1">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div>
                                            <img src="../static/akademi/images/avatar/2.jpg" class="avatar avatar-lg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card h-auto schedule-card-2">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div>
                                            <img src="../static/akademi/images/avatar/3.jpg" class="avatar avatar-lg" alt="">
                                        </div>
                                    </div>
                            ...
                            <div class="card h-auto schedule-card-3">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div>
                                            <img src="../static/akademi/images/avatar/4.jpg" class="avatar avatar-lg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
