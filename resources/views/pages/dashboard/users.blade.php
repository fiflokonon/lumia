                            ...
                            <table id="teacher-table" class="tech-data" style="min-width: 798px">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end"><span
                                            class="badge badge-sm light badge-danger">Bad</span></td>
                                </tr>
                                <tr>
                                    <td>Ramen</td>
                                    <td>Basic Art</td>
                    ...
                    <div class="table-responsive basic-tbl">
                        <table id="example-1" class="display" style="min-width: 845px">
                            ...
                            <tr>
                                <td>
                                    <div class="trans-list">
                                        <img src="../static/akademi/images/trans/1.jpg" alt=""
                                            ...
                                            <div class="dropdown custom-dropdown ">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item"
                                                       href="javascript:void(0);">Option 1</a>
                                                    <a class="dropdown-item"
                                                       href="javascript:void(0);">Option 2</a>
                                                    <a class="dropdown-item"
                                                       href="javascript:void(0);">Option 3</a>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            <tr>
                                <td>
                                    <div class="trans-list">
                                        <img src="../static/akademi/images/trans/2.jpg" alt=""
                                             class="avatar avatar-sm me-3">
                                        <h4>Tony Soap</h4>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="trans-list">
                                        <img src="../static/akademi/images/trans/3.jpg" alt=""
                                             class="avatar avatar-sm me-3">
                                        <h4>Jordan Nico</h4>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="trans-list">
                                        <img src="../static/akademi/images/trans/4.jpg" alt=""
                                             class="avatar avatar-sm me-3">
                                        <h4>Karen Hope</h4>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="trans-list">
                                        <img src="../static/akademi/images/trans/5.jpg" alt=""
                                             class="avatar avatar-sm me-3">
                                        <h4>Nadila Adja</h4>
                                    </div>
                                </td>
                    ...
                    <div class="card-header pb-0 border-0 flex-wrap">
                        <div class="mb-2 mb-sm-0">
                            <div class="chart-title mb-3">
                                <h2 class="heading">Indication de performance</h2>
                            </div>
                        </div>
                        <div class="p-static">
                            <div class="d-flex align-items-center mb-3 mb-sm-0">
                                <div class="round weekly" id="dzOldSeries">
                                    ...
                                    <div>
                                        <span class="fs-14">Abonnement</span>
                                ...
                                <div class="round" id="dzNewSeries">
                                    ...
                                    <div>
                                        <span class="fs-14">Inscription</span>
            ...
            <div class="col-xl-6">
                <div class="card h-auto">
                    <div class="card-header border-0 pb-0 flex-wrap">
                        <h4 class="heading mb-3 mb-sm-0">Statistiques générales</h4>
